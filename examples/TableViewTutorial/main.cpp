...
int main(int argCount, char *argVector[])
{
    ...
    KAboutData aboutData(QStringLiteral("tableviewexample"),
                         i18nc("@title:window", "LingmoUI Addons Table Example"),
                         QStringLiteral("1.0"),
                         i18nc("@info", "This program shows how to use TableView component from LingmoUI Addons"),
    ...
    qmlRegisterUncreatableType<BookListModel>("org.kde.lingmouiaddons.BookListModel",
                                              1,
                                              0,
                                              "BookRoles",
                                              QStringLiteral("Cannot create instances of BookListModel"));

    qmlRegisterUncreatableType<BookTableModel>("org.kde.lingmouiaddons.BookTableModel",
                                               1,
                                               0,
                                               "BookRoles",
