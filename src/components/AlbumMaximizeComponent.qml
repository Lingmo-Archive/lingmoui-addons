...
AbstractMaximizeComponent {
     ...
     */
    property LingmoUI.Action playAction
     ...
     * if you want to be able to interface with a media manager.
     */
    property LingmoUI.Action pauseAction
    ...
    actions: [
        ...
        LingmoUI.Action {
            ...
            text: i18nd("lingmoui-addons6", "Rotate left")
            icon.name: "object-rotate-left"
            onTriggered: view.currentItem.rotationAngle = view.currentItem.rotationAngle - 90
        },
        LingmoUI.Action {
            visible: view.currentItem.type === AlbumModelItem.Image
            text: i18nd("lingmoui-addons6", "Rotate right")
            icon.name: "object-rotate-right"
            onTriggered: view.currentItem.rotationAngle = view.currentItem.rotationAngle + 90
        },
        LingmoUI.Action {
            text: hideCaption ? i18ndc("lingmoui-addons6", "@action:intoolbar", "Show caption") : i18ndc("lingmoui-addons6", "@action:intoolbar", "Hide caption")
            icon.name: "add-subtitle"
            visible: root.showCaption && view.currentItem.caption
            onTriggered: hideCaption = !hideCaption
        },
        LingmoUI.Action {
            text: i18nd("lingmoui-addons6", "Save as")
    ...
    content: ListView {
        ...
        LingmoUIComponents.FloatingButton {
            ...
            visible: !LingmoUI.Settings.isMobile && view.currentIndex > 0
            Keys.forwardTo: view
            Accessible.name: i18nd("lingmoui-addons6", "Previous image")
            onClicked: {
        ...
        LingmoUIComponents.FloatingButton {
            ...
            visible: !LingmoUI.Settings.isMobile && view.currentIndex < view.count - 1
            Keys.forwardTo: view
            Accessible.name: i18nd("lingmoui-addons6", "Next image")
            onClicked: {
                view.currentItem.pause()
                view.currentIndex += 1
                if (root.autoPlay) {
    ...
    footer: QQC2.Control {
        ...
        contentItem: QQC2.ScrollView {
            ...
            contentItem: Flickable {
                ...
                contentHeight: captionLabel.height - captionLabel.padding * 2 + LingmoUI.Units.largeSpacing
