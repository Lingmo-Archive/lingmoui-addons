...
QQC2.Popup {
    ...
    ColumnLayout {
            ...
            contentItem: RowLayout {
                ...
                ColumnLayout {
                    ...
                    QQC2.Label {
                        id: titleLabel
                        Layout.fillWidth: true
                        Layout.maximumWidth: implicitWidth + LingmoUI.Units.largeSpacing
                ...
                QQC2.ToolButton {
                    ...
                    action: LingmoUI.Action {
                        text: i18nd("lingmoui-addons6", "Close")
        ...
        Item {
            id: footerParent
            Layout.fillWidth: true
            Layout.preferredHeight: root.footer ? root.footer.implicitHeight > LingmoUI.Units.gridUnit * 12 ? LingmoUI.Units.gridUnit * 12 : root.footer.implicitHeight : 0
