...
Item {
     ...
     */
    property LingmoUI.Action playAction: LingmoUI.Action {
        onTriggered: videoItem.play()
    }
     ...
     * if you want to be able to interface with a media manager.
     */
    property LingmoUI.Action pauseAction: LingmoUI.Action {
     ...
     * image.
     */
    property var padding: LingmoUI.Units.largeSpacing
    ...
    Video {
        ...
        Behavior on width {
            NumberAnimation {duration: LingmoUI.Units.longDuration; easing.type: Easing.InOutCubic}
        }
        Behavior on height {
            NumberAnimation {duration: LingmoUI.Units.longDuration; easing.type: Easing.InOutCubic}
        }
        ...
        QQC2.Control {
            ...
            contentItem: RowLayout {
                ...
                QQC2.ToolButton {
                    ...
                    QQC2.ToolTip.timeout: LingmoUI.Units.toolTipDelay
                    QQC2.ToolTip.text: i18ndc("lingmoui-addons6", "@action:button", "Volume")
                    ...
                    QQC2.Popup {
                        ...
                        QQC2.Slider {
                            id: volumeSlider
                            anchors.centerIn: parent
                            implicitHeight: LingmoUI.Units.gridUnit * 7
