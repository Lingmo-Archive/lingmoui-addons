 ...
 *
 * @deprecated Use LingmoUI.SearchDialog instead.
 *
 ...
 * }
 * @endcode
 * @since LingmoUIAddons.labs.components 1.0
 * @see SearchDialog
 */
QQC2.Control {
    id: root
    ...
    */
    ...
    property LingmoUI.SearchField searchField: LingmoUI.SearchField {}
    ...
    function __openPopupIfSearchFieldHasActiveFocus() {
        if (searchField && searchField.activeFocus && !popup.opened) {
            ...
            Qt.callLater(() => {
                // TODO: LingmoUI.OverlayZStacking fails to find and bind to
                ...
                if (!popup.visible) {
                    if (typeof popup.LingmoUI.OverlayZStacking !== "undefined") {
                        popup.z = Qt.binding(() => popup.LingmoUI.OverlayZStacking.z);
                    }
                }
                popup.open();
            });
    ...
    T.Popup {
        ...
        Component.onCompleted: {
            ...
            if (typeof LingmoUI.OverlayZStacking !== "undefined") {
                LingmoUI.OverlayZStacking.layer = LingmoUI.OverlayZStacking.Dialog;
                z = Qt.binding(() => LingmoUI.OverlayZStacking.z);
            }
        }
        ...
        readonly property real realisticHeight: {
            const wantedHeight = (root.searchField ? root.searchField.implicitHeight : 0) + LingmoUI.Units.gridUnit * 20;
        ...
        readonly property real yOffset: {
            ...
            return Math.max(-root.LingmoUI.ScenePosition.y, Math.min(0, overlay.height - root.LingmoUI.ScenePosition.y - realisticHeight));
        }
