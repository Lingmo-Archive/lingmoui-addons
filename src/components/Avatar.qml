...
//BEGIN properties
     ...
     *
     * @see org::kde::lingmouiaddons::components::Avatar::InitialsMode
     */
     ...
     *
     * @see org::kde::lingmouiaddons::components::Avatar::ImageMode
     */
    ...
    readonly property color __textColor: LingmoUI.ColorUtils.brightnessForColor(root.color) === LingmoUI.ColorUtils.Light
                            ? "black"
                            : "white"
    ...
    Item {
        ...
        Text {
            ...
            visible: root.initialsMode === Avatar.InitialsMode.UseInitials &&
                    ...
                    root.width > LingmoUI.Units.gridUnit
            ...
            font {
                ...
                pointSize: -1
                pixelSize: Math.round((root.height - LingmoUI.Units.largeSpacing) / 2)
            }
        ...
        layer {
            enabled: true
            effect: LingmoUI.ShadowedTexture {
                ...
                color: LingmoUI.ColorUtils.tintWithAlpha(LingmoUI.Theme.backgroundColor, border.color, 0.07)
            }
        }
    }
}
