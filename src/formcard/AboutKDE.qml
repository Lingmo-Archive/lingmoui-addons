 ...
 *
 * @inherit LingmoUI.ScrollablePage
 */
FormCardPage {
    id: page

    title: i18nd("lingmoui-addons6", "About KDE")
    ...
    FormCard {
        ...
        AbstractFormDelegate {
            ...
            contentItem: RowLayout {
                ...
                ColumnLayout {
                    ...
                    LingmoUI.Heading {
                        Layout.fillWidth: true
                        text: i18nd("lingmoui-addons6", "KDE")
                    ...
                    LingmoUI.Heading {
                        ...
                        wrapMode: Text.WordWrap
                        text: i18nd("lingmoui-addons6", "Be Free!")
                    }
                }
            }
        }
        ...
        FormTextDelegate {
            text: i18nd("lingmoui-addons6", "KDE is a world-wide community of software engineers, artists, writers, translators and creators who are committed to Free Software development. KDE produces the Lingmo desktop environment, hundreds of applications, and the many software libraries that support them.\n\n\
KDE is a cooperative enterprise: no single entity controls its direction or products. Instead, we work together to achieve the common goal of building the world's finest Free Software. Everyone is welcome to join and contribute to KDE, including you.")
    ...
    FormHeader {
        title: i18nd("lingmoui-addons6", "Report bugs")
    }

    FormCard {
        FormTextDelegate {
            text: i18nd("lingmoui-addons6", "Software can always be improved, and the KDE team is ready to do so. However, you - the user - must tell us when something does not work as expected or could be done better.\n\n\
...
If you have a suggestion for improvement then you are welcome to use the bug tracking system to register your wish. Make sure you use the severity called \"Wishlist\".")
    ...
    FormHeader {
        title: i18nd("lingmoui-addons6", "Join us")
    }

    FormCard {
        FormTextDelegate {
            text: i18nd("lingmoui-addons6", "You do not have to be a software developer to be a member of the KDE team. You can join the language teams that translate program interfaces. You can provide graphics, themes, sounds, and improved documentation. You decide!")
            textItem.wrapMode: Text.WordWrap
        }
        ...
        FormButtonDelegate {
            id: devDoc
            text: i18nd("lingmoui-addons6", "Developer Documentation")
            onClicked: Qt.openUrlExternally("https://develop.kde.org/")
        }
    }

    FormHeader {
        title: i18nd("lingmoui-addons6", "Support us")
    }

    FormCard {
        FormTextDelegate {
            text: i18nd("lingmoui-addons6", "KDE software is and will always be available free of charge, however creating it is not free.\n\n\
...
Thank you very much in advance for your support.")
        ...
        FormButtonDelegate {
            id: ev
            text: i18nd("lingmoui-addons6", "KDE e.V")
