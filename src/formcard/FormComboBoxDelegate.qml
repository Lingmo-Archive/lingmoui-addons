...
AbstractFormDelegate {
    ...
    enum DisplayMode {
         ...
         * shows a LingmoUI.OverlaySheet at the middle of the window
         * containing a vertical list of values.
         */
        Dialog,
        /**
         * A button with similar appearance to a combobox that, when clicked,
         * shows a LingmoUI.ScrollablePage in a new window containing a
     ...
     * @see DisplayMode
     */
    property int displayMode: LingmoUI.Settings.isMobile ? FormComboBoxDelegate.Dialog : FormComboBoxDelegate.ComboBox
    ...
    property Component comboBoxDelegate: Delegates.RoundedItemDelegate {
        implicitWidth: ListView.view ? ListView.view.width : LingmoUI.Units.gridUnit * 16
    ...
    property Component dialogDelegate: Delegates.RoundedItemDelegate {
        ...
        Layout.topMargin: index == 0 ? Math.round(LingmoUI.Units.smallSpacing / 2) : 0
     ...
     */
    property var dialog: LingmoUI.Dialog {
        id: dialog
     ...
     * LingmoUI.ScrollablePage with a custom component.
     */
    property Component page: LingmoUI.ScrollablePage {
        title: controlRoot.text
