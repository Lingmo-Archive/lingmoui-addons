...
class QAction;
class LingmoUIActionCollection;
...
public:
    ...
    struct Item {
        LingmoUIActionCollection *collection;
    ...
    void refresh(const QList<LingmoUIActionCollection*> &actionCollections);
...
private:
    QList<Item> m_items;
    QList<LingmoUIActionCollection *> m_collections;
};
