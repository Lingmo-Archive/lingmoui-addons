...
import org.kde.lingmouiaddons.statefulapp.private
    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            QQC2.Button {
                ...
                text: {
                    ...
                    const text = helper.keySequenceIsEmpty(keySequence)
                        ? (helper.isRecording
                            ? i18ndc("lingmoui-addons6", "What the user inputs now will be taken as the new shortcut", "Input")
                            : i18ndc("lingmoui-addons6", "No shortcut defined", "None"))
                ...
                Accessible.description: i18nd("lingmoui-addons6", "Click on the button, then enter the shortcut like you would in the program.\nExample for Ctrl+A: hold the Ctrl key and press A.")
            ...
            QQC2.Button {
                ...
                text: i18ndc("lingmoui-addons6", "@info:tooltip", "Clear Key Sequence")
            ...
            QQC2.Button {
                ...
                display: QQC2.Button.IconOnly
                text: i18ndc("lingmoui-addons6", "@info:tooltip", "Cancel Key Sequence Recording")
