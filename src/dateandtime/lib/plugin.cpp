...
class LingmoUIAddonsDataAndTimePlugin : public QQmlExtensionPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QQmlExtensionInterface")

public:
    LingmoUIAddonsDataAndTimePlugin() = default;
    ~LingmoUIAddonsDataAndTimePlugin() = default;
    void registerTypes(const char *uri) override;
};

void LingmoUIAddonsDataAndTimePlugin::registerTypes(const char *uri)
{
