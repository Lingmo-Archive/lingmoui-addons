...
import org.kde.lingmouiaddons.dateandtime 1.0
                ...
                Item {
                    ...
                    Accessible.name: {
                        if (modelData.action === dayAction) {
                            return i18nd("lingmoui-addons6", "Day")
                        }
                        if (modelData.action === monthAction) {
                            return i18nd("lingmoui-addons6", "Month")
                        }
                        if (modelData.action === yearsViewCheck) {
                            return i18nd("lingmoui-addons6", "Year")
                        }
                        return ""
                    }
            ...
            Components.SegmentedButton {
                actions: [
                    LingmoUI.Action {
                        ...
                        text: i18ndc("lingmoui-addons6", "@action:button", "Go Previous")
                    ...
                    LingmoUI.Action {
                        text: i18ndc("lingmoui-addons6", "@action:button", "Jump to today")
                        displayHint: LingmoUI.DisplayHint.IconOnly
                    ...
                    LingmoUI.Action {
                        id: goNextAction
                        text: i18ndc("lingmoui-addons6", "@action:button", "Go Next")
