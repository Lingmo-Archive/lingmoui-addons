...
RowLayout {
    ...
    Component {
        ...
        Label {
            ...
            Rectangle {
                anchors.fill: parent
                color: 'transparent'
                radius: LingmoUI.Units.mediumSpacing
                border {
    ...
    Tumbler {
        ...
        Accessible.name: i18nd("lingmoui-addons6", "Hours")
    ...
    Label {
        ...
        text: i18ndc("lingmoui-addons6", "Time separator", ":")
        font.pointSize: LingmoUI.Theme.defaultFont.pointSize * 1.3
        Accessible.ignored: true
    }
    ...
    Tumbler {
        ...
        Accessible.name: i18nd("lingmoui-addons6", "Minutes")
        Accessible.role: Accessible.Dial
