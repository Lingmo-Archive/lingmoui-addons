 ...
 * @inherit kde::org::lingmoui::PageRow
...
LingmoUI.PageRow {
     ...
     */
    property list<LingmoUI.PagePoolAction> actions

    property alias _stack: root
    property LingmoUI.PagePool _pool: LingmoUI.PagePool {}

    readonly property string title: root.depth < 2 ? i18ndc("lingmoui-addons6", "@title:window", "Settings") :i18ndc("lingmoui-addons6", "@title:window", "Settings — %1", root.get(1).title)
    ...
    readonly property QtObject _fakeApplicationWindow: QtObject {
        readonly property LingmoUI.PageRow pageStack: root
    ...
    globalToolBar {
        ...
        showNavigationButtons: if (root.currentIndex > 0) {
            LingmoUI.ApplicationHeaderStyle.ShowBackButton
        } else {
            0
        }
    }
    ...
    columnView.columnWidth: LingmoUI.Units.gridUnit * 13

    initialPage: LingmoUI.ScrollablePage {
        bottomPadding: 0
        leftPadding: 0
        rightPadding: 0
        topPadding: 0
        ...
        titleDelegate: RowLayout {
            ...
            QQC2.ToolButton {
                ...
                text: i18ndc("lingmoui-addons6", "@action:intoolbar", "Go back")
        ...
        ListView {
            ...
            onWidthChanged: if (!initDone && root.width >= LingmoUI.Units.gridUnit * 30) {
