...
LingmoUI.ApplicationWindow {
    ...
    pageStack {
        ...
        globalToolBar {
            ...
            showNavigationButtons: root.pageStack.depth > 1 ? LingmoUI.ApplicationHeaderStyle.ShowBackButton : LingmoUI.ApplicationHeaderStyle.NoNavigationButtons
        }
    }
    ...
    globalDrawer: LingmoUI.OverlayDrawer {
        ...
        drawerOpen: true
        width: LingmoUI.Units.gridUnit * 13
