...
import org.kde.lingmouiaddons.treeview 1.0 as Tree
...
Delegates.RoundedItemDelegate {
    ...
    leftPadding: (Qt.application.layoutDirection !== Qt.RightToLeft ? decoration.width + root.padding * 2 : 0) + LingmoUI.Units.smallSpacing

    rightInset: (Qt.application.layoutDirection === Qt.RightToLeft ? decoration.width + root.padding * 2 : 0) + LingmoUI.Units.smallSpacing
    rightPadding: (Qt.application.layoutDirection === Qt.RightToLeft ? decoration.width + root.padding * 2 : 0) + LingmoUI.Units.smallSpacing * 2
