...
LingmoUI.ApplicationWindow {
    ...
    pageStack.defaultColumnWidth: LingmoUI.Units.gridUnit * 35
    pageStack.globalToolBar.style: LingmoUI.ApplicationHeaderStyle.ToolBar;
    pageStack.globalToolBar.showNavigationButtons: LingmoUI.ApplicationHeaderStyle.ShowBackButton;
            ...
            ColumnLayout {
                ...
                FormCard.FormCard {
                    ...
                    FormCard.FormDateTimeDelegate {
                        ...
                        status: LingmoUI.MessageType.Warning
                ...
                FormCard.FormCard {
                    FormCard.FormComboBoxDelegate {
                        id: dropdown1
                        text: "Select a color"
                        Component.onCompleted: currentIndex = indexOfValue("Ocean Blue")
                        model: ["Ocean Blue", "Konqi Green", "Velvet Red", "Bright Yellow"]
                    }
                ...
                FormCard.FormCard {
                    ...
                    FormCard.AbstractFormDelegate {
                        ...
                        contentItem: RowLayout {
                            ...
                            Controls.TextField {
                                Layout.preferredWidth: LingmoUI.Units.gridUnit * 8
                ...
                FormCard.FormCard {
                    ...
                    FormCard.FormTextFieldDelegate {
                        ...
                        status: LingmoUI.MessageType.Error
                    ...
                    FormCard.FormTextFieldDelegate {
                        ...
                        text: "4242424242"
                        status: LingmoUI.MessageType.Positive
                        echoMode: TextInput.Password
                    }
                }
